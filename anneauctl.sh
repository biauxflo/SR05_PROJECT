...
./app/app -n A1 < /tmp/in_A1 > /tmp/out_A1 &
./ctl/ctl -n C1 < /tmp/in_C1 > /tmp/out_C1 &

./app/app -n A2 < /tmp/in_A2 > /tmp/out_A2 &
./ctl/ctl -n C2 < /tmp/in_C2 > /tmp/out_C2 &

./app/app -n A3 < /tmp/in_A3 > /tmp/out_A3 &
./ctl/ctl -n C3 < /tmp/in_C3 > /tmp/out_C3 &
